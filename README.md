...
ECFE is compatible with mods that replace the AdvancedSetup, GameSetupLogic, and HostGame Frontend Lua context script files. See "Conflicts" below for details and limitations.
...
See "Features" above for more details. If your mod replaces any of these files, compatibility issues ***WILL*** arise.
